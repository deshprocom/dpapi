...
RSpec.describe Services::Account::EmailLoginService do
  ...
  context "用户不存在" do
    it "should return code 1100016" do
      email_service = Services::Account::EmailLoginService
      api_result = email_service.call('ricky@qq.com', 'test123')
  ...
  context "密码不正确" do
    it "should return code 1100015" do
      email_service = Services::Account::EmailLoginService
      api_result = email_service.call('ricky@deshpro.com', 'test12')
  ...
  context "通过邮箱和密码正常登录" do
    it "should return code 1100015" do
      email_service = Services::Account::EmailLoginService
      api_result = email_service.call('ricky@deshpro.com', 'test123')
